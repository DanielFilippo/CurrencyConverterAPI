...
namespace CurrencyConverterUnitTests.UnitTests
{
    public class CalcConversionUnitTests
    {
        ...
        public void CalcConversion_CalculateConversion_ReturnSucess(double value, double valueCurrencyTo, double valueCurrencyFrom, double expectedResult)
        {
            CalcConversion calcConversion = new CalcConversion();
            double result = calcConversion.calculateConversion(new CalcConversion(value, valueCurrencyTo, valueCurrencyFrom));
